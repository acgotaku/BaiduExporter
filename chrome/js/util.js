    ...
    var baidupan = (function() {
        ...
        return {
            ...
            get_convert_dir:function(fs_id){
                ...
                self.create_dir(path).done(function(value){ 
                ...
                function delayLoopList(path){
                    setTimeout(function(){
                        self.create_dir(path).then(function(value){
